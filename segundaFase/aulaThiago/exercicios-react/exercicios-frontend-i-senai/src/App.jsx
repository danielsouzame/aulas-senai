...
import DataAtualCompleta from './componentes/DataCompletaAtual/DataAtualCompleta';
...
function App() {
  ...
  const numeros = [1, 2, 5, 6, 7, 10, 12, 13, 15, 20, 24, 31]
  const nomes = ["Lizzie Patterson",  "Freeman Dickson", "Arline Allison", "Elnora Clarke", "Maude Staton"]
  return (
    <>
      <span>
      ...
      <Calculadora num1={10} num2={5} operacao={3}/>
      <hr />
      <span>
      ...
      <TamanhoTexto texto = {"Olá Mundo! Como vai você?"}/>
      <hr />
      <span>
